# Qlib Exchange: Volume Limits, Trading Limits, and Execution Prices
...
2. **Apply Trading Rules (The // Step - Enforcing Lot Size)**:
   ...
   Note: The `//` operator causes a **partial fill**  -  50 real shares (33% of original demand) are unexecutable.
